...
__align(32) u8 mem1base[MEMORY_MAX_SIZE];									
__align(32) u8 mem2base[MEMORY_MAX_SIZE] __attribute__((at(0X68000000)));					
__align(32) u8 mem3base[MEMORY_MAX_SIZE] __attribute__((at(0X10000000)));	


u16 mem1mapbase[MEMORY_MAX_SIZE];							//内部SRAM内存管理表MAP
u16 mem2mapbase[MEMORY_MAX_SIZE] __attribute__((at(0X68000000+MEMORY_MAX_SIZE)));	//外部SRAM MAP
u16 mem3mapbase[MEMORY_MAX_SIZE] __attribute__((at(0X10000000+MEMORY_MAX_SIZE)));	//内部CCM MAP
...
/* 定义一个内存管理表 */
u16 MemoryManagementMap[MAP_TABLE_SIZE] __attribute__((at(0X68000000 + MEMORY_MAX_SIZE)));
